        ...
        <Row className="align-items-center">
          ...
          <Col size={12} sm={6} className="text-center text-sm-end">
            <div className="social-icon">
                <a href="https://discordapp.com/users/karvaregzel" target="_blank"><img src={navIcon1} alt="Discord" /></a>
                <a href="https://github.com/nodexcapital"target="_blank"><img src={navIcon2} alt="Github" /></a>
                <a href="https://twitter.com/marshalexyz" target="_blank"><img src={navIcon3} alt="Twitter" /></a>
                <a href="https://youtube.com" target="_blank"><img src={navIcon4} alt="Youtube" /></a>
            </div>
            <p>Made with ❤️ Karvaregzel | Founder of Karva Capital</p>
          </Col>
        </Row>
      </Container>
    </footer>
